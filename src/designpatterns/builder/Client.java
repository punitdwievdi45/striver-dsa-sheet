...
/*While creating object when object contain many attributes there are many problem exists :
    ...
    3. factory class takes all responsibility for creating object, if the object is heavy then all complexity
...
public class Client {
    public static void main(String[] args) {
        ...
        Phone phone1 = new PhoneBuilder().setPhoneId("1").build();
